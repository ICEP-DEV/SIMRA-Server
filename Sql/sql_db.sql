...
--
-- Table structure for table `province`-- phpMyAdmin SQL Dump
-- version 5.2.0
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1
...
INSERT INTO `FIBdata` (`indicatorid`, `indicator_name`, `ratio`, `count`, `countAverage`) VALUES
(1, 'Coliforms',5,1,5),
(2, 'E. coli',6,3,18),
(3, 'Enterococcus ',6,3,18),
(4, 'Clostridium',6,3,18);
...
-- --------------------------------------------------------
-- Table structure for table `mst_data`
--

CREATE TABLE `mst_data` (
  `mst_id` int(12) NOT NULL,
  `mst_name` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `mst_data`
--

INSERT INTO `mst_data` (`mst_id`, `mst_name`) VALUES
(1, 'Cow'),
(2, 'Human'),
(3, 'Dog'),
(4, 'Pig'),
...
INSERT INTO `mst_maker` (`mstdata_id`, `mstdata_names`, `ratio_mst`, `count_mst`, `count_estimate`) VALUES
(1, 'Cow', 0.66, 3, 6.1),
(2, 'Human', 1.1, 2, 4.2),
(3, 'Dog', 0.01, 3.1, 1.2),
(4, 'Pig', 1.3, 4.2, 3.3),
(5, 'Chicken', 1.2, 1.4, 1.1);
...
(1, NULL, NULL, 0.059, NULL, NULL, 'Cryptosporidium parvum', 2, 1.1),
(2, 0.4, 54.9, NULL, NULL, NULL, 'E. coli O157:H7', 3, 2.3),
(3, 0.145, 7.58, NULL, NULL, NULL, 'Campylobacter jejuni', 4, 1.0),
(4, 0.21, 49.78, NULL, NULL, NULL, 'Salmonella typhi', 5, 0.2),
(5, 0.256, 1480, NULL, NULL, NULL, 'S. Flexneri', 6, 2.5),
(6, 0.169, 2305, NULL, NULL, NULL, 'Vibrio cholera', 7, 3.3),
(7, NULL, NULL, NULL, 0.0199, NULL, 'Giardia lambia', 8, 0.7),
(8, 0.101, NULL, NULL, NULL, 341, 'Entamoeba col', 9, 0.3);
...
-- Indexes for table `mst_data`
--
ALTER TABLE `mst_data`
...
-- AUTO_INCREMENT for table `mst_data`
--
ALTER TABLE `mst_data`
MODIFY `mst_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;


-- AUTO_INCREMENT for table `mst_maker`
--
ALTER TABLE `mst_maker`
MODIFY `mstdata_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

-- AUTO_INCREMENT for table `parameters`
--
ALTER TABLE `parameters`
MODIFY `parameterid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
